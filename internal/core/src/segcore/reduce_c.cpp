...
Marshal(CSearchResultData* cSearchResultData,
    ...
    try {
        ...
        *search_result_data->mutable_scores() = {result_distances.begin(), result_distances.end()};
        ...
        std::cout << "[c search result] " << "nq = " << search_result_data->num_queries() << std::endl;
        std::cout << "[c search result] " << "topK = " << search_result_data->top_k() << std::endl;
        std::cout << "[c search result] " << "ids size = " << search_result_data->ids().int_id().data_size() << std::endl;
        std::cout << "[c search result] " << "scores size = " << search_result_data->scores().size() << std::endl;
        std::cout << "[c search result] " << "scores = " << search_result_data->scores().data() << std::endl;
