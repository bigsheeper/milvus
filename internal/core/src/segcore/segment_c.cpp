...
Search(CSegmentInterface c_segment,
    ...
    std::cout << log_prefix << "cgo::Search searching..., timestamp = " << timestamp << ", segmentPtr = " << c_segment
              << ", planPtr = " << c_plan << ", placeholderPtr = " << c_placeholder_group << ", resultPtr = " << result
              << std::endl;
    try {
        auto segment = (milvus::segcore::SegmentInterface*)c_segment;
        std::cout << log_prefix << "cgo::Search init segment done, segment = " << segment << std::endl;
        auto plan = (milvus::query::Plan*)c_plan;
        std::cout << log_prefix << "cgo::Search init plan done, plan = " << plan << std::endl;
        auto phg_ptr = reinterpret_cast<const milvus::query::PlaceholderGroup*>(c_placeholder_group);
        std::cout << log_prefix << "cgo::Search init placeHolderGroup done, phg_ptr = " << phg_ptr << std::endl;
        auto search_result = segment->Search(plan, *phg_ptr, timestamp);
        std::cout << log_prefix << "cgo::Search done, search_result = " << &search_result << std::endl;
        ...
        *result = search_result.release();
        std::cout << log_prefix << "cgo::Search result release done, result = " << result << std::endl;
