...
func (_m *MockSegmentManager) EXPECT() *MockManager_Expecter {
...
// NewMockManager creates a new instance of MockSegmentManager. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
