...
func TestCluster_Index(t *testing.T) {
	...
	t.Run("query index", func(t *testing.T) {
		...
		// Test
		result, err := cluster.QueryIndex(1, &workerpb.QueryJobsRequest{})
		assert.NoError(t, err)
		assert.NotNil(t, result)
	})
	...
	t.Run("drop index", func(t *testing.T) {
		...
		// Test
		err := cluster.DropIndex(1, &workerpb.DropJobsRequest{})
		assert.NoError(t, err)
	})
}
...
func TestCluster_Stats(t *testing.T) {
	...
	t.Run("query stats", func(t *testing.T) {
		...
		// Test
		result, err := cluster.QueryStats(1, &workerpb.QueryJobsRequest{})
		assert.NoError(t, err)
		assert.NotNil(t, result)
	})
	...
	t.Run("drop stats", func(t *testing.T) {
		...
		// Test
		err := cluster.DropStats(1, &workerpb.DropJobsRequest{})
		assert.NoError(t, err)
	})
}
...
func TestCluster_Analyze(t *testing.T) {
	...
	t.Run("query analyze", func(t *testing.T) {
		...
		// Test
		result, err := cluster.QueryAnalyze(1, &workerpb.QueryJobsRequest{})
		assert.NoError(t, err)
		assert.NotNil(t, result)
	})
	...
	t.Run("drop analyze", func(t *testing.T) {
		...
		// Test
		err := cluster.DropAnalyze(1, &workerpb.DropJobsRequest{})
		assert.NoError(t, err)
	})
}
