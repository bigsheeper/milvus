...
// DropCompaction provides a mock function with given fields: nodeID, in
func (_m *MockCluster) DropCompaction(nodeID int64, in *datapb.DropCompactionPlanRequest) error {
	ret := _m.Called(nodeID, in)
...
func (_e *MockCluster_Expecter) DropCompaction(nodeID interface{}, in interface{}) *MockCluster_DropCompaction_Call {
	return &MockCluster_DropCompaction_Call{Call: _e.mock.On("DropCompaction", nodeID, in)}
}

func (_c *MockCluster_DropCompaction_Call) Run(run func(nodeID int64, in *datapb.DropCompactionPlanRequest)) *MockCluster_DropCompaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockCluster_DropCompaction_Call) RunAndReturn(run func(int64, *datapb.DropCompactionPlanRequest) error) *MockCluster_DropCompaction_Call {
	_c.Call.Return(run)
	return _c
}
...
// QuerySlot provides a mock function with given fields:
