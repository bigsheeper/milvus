...
func (node *DataNode) FlushSegments(ctx context.Context, req *datapb.FlushSegmentsRequest) (*commonpb.Status, error) {
	log.Warn("receive deprecated FlushSegments request",
		zap.Int64("nodeID", node.GetNodeID()), zap.Int64("sourceID", req.GetBase().GetSourceID()))
	return merr.Success(), nil
}
...
func (node *DataNode) SyncSegments(ctx context.Context, req *datapb.SyncSegmentsRequest) (*commonpb.Status, error) {
	log.Warn("receive deprecated SyncSegments request", zap.Int64("nodeID", node.GetNodeID()))
	return merr.Success(), nil
}

// Deprecated in 2.6.x, keep it for compatibility during rolling upgrade.
func (node *DataNode) NotifyChannelOperation(ctx context.Context, req *datapb.ChannelOperationsRequest) (*commonpb.Status, error) {
	log.Warn("receive deprecated NotifyChannelOperation request", zap.Int64("nodeID", node.GetNodeID()))
...
func (node *DataNode) CheckChannelOperationProgress(ctx context.Context, req *datapb.ChannelWatchInfo) (*datapb.ChannelOperationProgressResponse, error) {
	log.Warn("receive deprecated CheckChannelOperationProgress request", zap.Int64("nodeID", node.GetNodeID()))
...
func (node *DataNode) FlushChannels(ctx context.Context, req *datapb.FlushChannelsRequest) (*commonpb.Status, error) {
	log.Warn("receive deprecated FlushChannels request",
		zap.Int64("nodeID", node.GetNodeID()), zap.Int64("sourceID", req.GetBase().GetSourceID()))
	return merr.Success(), nil
}
