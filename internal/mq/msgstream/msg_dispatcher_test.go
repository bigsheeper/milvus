...
//var msgTypeList = []commonpb.MsgType{
//	commonpb.MsgType_Insert,
//	commonpb.MsgType_Delete,
//	commonpb.MsgType_TimeTick,
...
//			msgType := msgTypeList[rand.Int()%len(msgTypeList)]
//			timestamp := beginTs + rand.Uint64()%(endTs-beginTs) // beginTs ~ endTs
//			pack.Msgs = append(pack.Msgs, genTsMsg(collectionID, msgType, timestamp))
//		}
