...
func (rl *rateLimiter) getRateConfigByRateType(rt internalpb.RateType) (float64, int) {
	...
	case internalpb.RateType_DDLFlush:
		return Params.QuotaConfig.DDLFlushRate, int(Params.QuotaConfig.DDLFlushRate)
	case internalpb.RateType_DDLCompaction:
		return Params.QuotaConfig.DDLCompactionRate, int(Params.QuotaConfig.DDLCompactionRate)
	...
	case internalpb.RateType_DMLBulkLoad:
		return Params.QuotaConfig.DMLBulkLoadRate, int(Params.QuotaConfig.DMLBulkLoadRate)
