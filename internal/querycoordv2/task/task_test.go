...
func (suite *TaskSuite) TestSubscribeChannelTask() {
	...
	suite.broker.EXPECT().GetRecoveryInfoV2(mock.Anything, suite.collection, int64(1)).Return(dmChannels, nil, nil)
...
func (suite *TaskSuite) TestLoadSegmentTask() {
	...
	suite.broker.EXPECT().GetRecoveryInfoV2(mock.Anything, suite.collection, int64(1)).Return(nil, segments, nil)
	suite.target.UpdateCollectionNextTargetWithPartitions(suite.collection, int64(1))
...
func (suite *TaskSuite) TestLoadSegmentTaskFailed() {
	...
	suite.broker.EXPECT().GetRecoveryInfoV2(mock.Anything, suite.collection, int64(1)).Return(nil, segmentInfos, nil)
	suite.target.UpdateCollectionNextTargetWithPartitions(suite.collection, int64(1))
	segmentsNum := len(suite.loadSegments)
	suite.AssertTaskNum(0, segmentsNum, 0, segmentsNum)
...
func (suite *TaskSuite) TestTaskCanceled() {
	...
	segmentsNum := len(suite.loadSegments)
	suite.AssertTaskNum(0, segmentsNum, 0, segmentsNum)
	suite.broker.EXPECT().GetRecoveryInfoV2(mock.Anything, suite.collection, partition).Return(nil, segmentInfos, nil)
...
func (suite *TaskSuite) TestSegmentTaskStale() {
	...
	suite.broker.EXPECT().GetRecoveryInfoV2(mock.Anything, suite.collection, int64(2)).Return(nil, segmentInfos, nil)
