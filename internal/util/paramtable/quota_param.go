...
func (p *quotaConfig) initMaxInsertSize() {
	size := p.Base.ParseFloatWithDefault("quotaAndLimits.dml.maxInsertSize", 64)
	p.MaxInsertSize = int(megaBytesRate2Bytes(size))
}

func (p *quotaConfig) initMaxDeleteSize() {
	size := p.Base.ParseFloatWithDefault("quotaAndLimits.dml.maxDeleteSize", 1)
...
func (p *quotaConfig) initMaxSearchSize() {
	size := p.Base.ParseFloatWithDefault("quotaAndLimits.dql.maxSearchSize", 0.1)
	p.MaxSearchSize = int(megaBytesRate2Bytes(size))
}

func (p *quotaConfig) initMaxQuerySize() {
	size := p.Base.ParseFloatWithDefault("quotaAndLimits.dql.maxQuerySize", 0.01)
